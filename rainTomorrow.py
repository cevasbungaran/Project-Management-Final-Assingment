...
# Membaca dataset 
df = pd.read_csv('weather_uts.csv')
...
selector1  = SelectKBest(score_func=chi2, k=2)
selector1.fit(X1, Y1)
...
df_new_weather_uts = pd.read_csv('new_weather_uts.csv', delimiter = ';')

X_new2 = df_new_weather_uts[['Rainfall', 'Humidity3pm']].values
